...
export const DEFAULT_PREFERRED_DAYS = 'Monday to Friday';
...
export function normalizeRegistrationPayload(
  ...
  return {
    ...
    preferredDays:
      getTrimmedString(payload.preferredDays) || DEFAULT_PREFERRED_DAYS,
...
export function getRegistrationFieldErrors(
  ...
  if (data.preferredDays.length > MAX_PREFERRED_DAYS_LENGTH) {
