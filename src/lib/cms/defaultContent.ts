...
export const DEFAULT_CMS_CONTENT: CmsContentBySectionKey = {
  ...
  afterschoolPrograms: {
    heroTitle: 'Kids Afterschool & Tutoring Programs',
    heroSubtitle: 'Sunday to Friday Available',
    activityOptions: [
      'Sunday: Custom Tutoring & Test Prep',
      'Monday: Chess & Homework Help',
      'Tuesday: Abacus & Brain Games',
      'Wednesday: Arts & Homework Help',
      'Thursday: Brain Games & Homework Help',
    ...
    activityScheduleLabel: 'Sunday to Friday',
    activityTimeLabel: 'Drop off anytime between 3 and 6 upto 2 hours',
    registrationTitle: 'Registration & Course Customizer',
    registrationDescription:
      'Select your grade, dates, subjects, tutoring days, and add-ons below. Your total payment amount is computed live before submitting.',
    ...
    preferredDaysLabel: 'Select Tutoring / Program Days',
    preferredDayOptions: [
      'Sunday',
      'Monday',
      'Tuesday',
    ...
    validationMessages: {
      ...
      preferredDaysRequired: 'Select at least one day.',
